...
class MockDetector:
    def __init__(self):
        ...
        self.targets = [
            MockTarget(1, "RED_CUBE", "TRAUMA MEDICAL CACHE", "P2 - HIGH",
                       "DISPATCH FIELD TRIAGE & MEDICAL EVAC TEAM", "1.4m x 1.4m x 0.9m",
                       28.05, -42.45, 0.06, 142, (0, 0, 220)),
            MockTarget(2, "YELLOW_CUBE", "HAZMAT TOXIC SPILL", "P1 - CRITICAL",
                       "CORDON 100M PERIMETER / HAZMAT CONTAINMENT", "1.5m x 1.5m x 1.0m",
                       86.12, -23.95, 0.05, 118, (0, 220, 220)),
            MockTarget(3, "GREEN_CUBE", "EMERGENCY RATIONS POD", "P2 - HIGH",
                       "SURVIVOR PROVISION REPLENISHMENT & DISTRIBUTION", "1.5m x 1.4m x 1.0m",
                       55.95, -6.08, 0.05, 126, (0, 200, 0)),
            MockTarget(4, "ORANGE_CUBE", "SURVIVOR SHELTER", "P1 - CRITICAL",
                       "DEPLOY SEARCH & RESCUE EXTRACTION TEAM IMMEDIATELY", "1.4m x 1.4m x 1.0m",
                       17.92, 8.04, 0.06, 95, (0, 140, 255)),
            MockTarget(5, "BLUE_CUBE", "EMERGENCY WATER IBC", "P2 - HIGH",
                       "RELIEF WATER LOGISTICS & DISTRIBUTION", "1.4m x 1.4m x 1.0m",
                       44.10, 23.90, 0.05, 110, (220, 80, 0)),
            MockTarget(6, "PURPLE_CUBE", "COMMS RELAY STATION", "P3 - LOGISTICS",
                       "SECURE TACTICAL MESH RADIO REPEATER LINK", "1.4m x 1.4m x 0.9m",
                       95.88, 42.40, 0.06, 88, (180, 0, 180)),
            MockTarget(7, "CYAN_CUBE", "UNEXPLODED ORDNANCE", "P1 - HAZARD",
                       "EOD / DEMINING DISPOSAL TEAM DISPATCH REQUIRED", "1.4m x 1.4m x 0.9m",
